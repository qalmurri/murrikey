% murrikey(SECTION) | User Commands
%
% "February 22 2026"
...
murrikey - program to do something

# SYNOPSIS

**murrikey** **-e** _this_ [**\-\-example=that**] [{**-e** | **\-\-example**} _this_]
                 [{**-e** | **\-\-example**} {_this_ | _that_}]

**murrikey** [{**-h** | *\-\-help**} | {**-v** | **\-\-version**}]

# DESCRIPTION

This manual page documents briefly the **murrikey** and **bar** commands.

This manual page was written for the Debian distribution because the
original program does not have a manual page. Instead, it has documentation
in the GNU info(1) format; see below.

**murrikey** is a program that...
...
:   The system-wide configuration file to control the behaviour of
    murrikey. See **foo.conf**(5) for further details.
...
**murrikey** provides some return codes, that can be used in scripts:
...
qalmurri <qalmurri@unknown>
:   Wrote this manpage for the Debian system.

# COPYRIGHT

Copyright © 2007 qalmurri
